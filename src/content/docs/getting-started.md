...
AgentMux is an agentic workflow environment — a desktop app for running, observing, and coordinating AI agents. Built on Rust with a bundled Chromium 148 via CEF and a SolidJS frontend.
